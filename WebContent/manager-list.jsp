                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加管理员信息','./manager-add.jsp',800,600)">
    					...
    					$.each(result,function(index,item){
    						$(".layui-table").append(`
									<tr>
										...
										<td><img src='`+item.mpicture+`'/></td>
										<td class="td-manage">
										   <!--  如果点击的时候就弹出页面  需要在food-edit。jsp  发送ajax请求获取数据 -->
                                            <div class="layui-btn-group">
	                                        	<button type="button" onclick="xadmin.open('编辑','manager-edit.jsp?mid=`+item.mid+`')" class="layui-btn ">修改</button>
	                                            <button type="button" onclick="window.location.href = 'manager?action=delete&mid=`+item.mid+`'" class="layui-btn">删除</button>
	                                         </div>
	                                	</td>
									</tr>
								`)	
