...
<div class="showcase-examples l-over l-center">
  <a href="foodpage?action=query" class="button button-rounded button-plain button-small-caps button-border">美食信息展示</a>
  <a href="goods?action=query" class="button button-rounded button-plain button-small-caps button-border">商品信息展示</a>
