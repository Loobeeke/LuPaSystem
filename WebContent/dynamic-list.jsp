                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <!-- <form class="layui-form layui-col-space5">
                                <div class="layui-input-inline layui-show-xs-block">
                                    <input type="text" id="theading" name="theading" placeholder="请输入标题信息" autocomplete="off" class="layui-input"></div>
                                <div class="layui-input-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','./dynamic-add.jsp',800,600)">
    ...
    <script>
       	...
       	$(function(){
    			...
    			$.ajax({
    				url:"Dynamic",
    				type:"post",
    				data:{"dtitle":$("#dtitle").val(),"action":"dynamiclist"},
    				dataType:"json",
    					...
    					$.each(result,function(index,item){
    						$(".layui-table").append(`
									<tr>
										...
										<td>`+item.ddate+`</td>
										<td>`+item.dtime+`</td>
										<td><img src='`+item.dpicture+`'/></td>
										<td class="td-manage">
										   
	                                         <div class="layui-btn-group">
	                                        	<button type="button" onclick="xadmin.open('编辑','dynamic-edit.jsp?dnumber=`+item.dnumber+`')" class="layui-btn ">修改</button>
	                                            <button type="button" onclick="window.location.href = 'Dynamic?action=delete&dnumber=`+item.dnumber+`'" class="layui-btn">删除</button>
	                                         </div>
	                                	</td>
									</tr>
								`)	
