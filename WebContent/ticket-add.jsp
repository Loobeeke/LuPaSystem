...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="Tickets?action=addtickets" method="post" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        <label for="detail" class="layui-form-label">
                            <span class="x-red">*</span>门票详情</label>
                        <div class="layui-input-inline">
                            <!-- <input type="text" id="theading" name="theading" required="" lay-verify="required" autocomplete="off" class="layui-input"> -->
                             <textarea placeholder="请输入内容" id="detail" name="detail" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="oldprice" name="oldprice" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                   <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="stock" name="stock" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
			         ...
			         <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width:250px;">
                            <input type="file" id="picture" name="picture" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
