                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                           <!--  <form class="layui-form layui-col-space5">
                                <div class="layui-input-inline layui-show-xs-block">
                                    <input type="text" id="theading" name="theading" placeholder="请输入门票名称" autocomplete="off" class="layui-input"></div>
                                <div class="layui-input-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加门票信息','./ticket-add.jsp',800,600)">
										...
										<td class="td-manage">
										   <!--  如果点击的时候就弹出页面  需要在food-edit。jsp  发送ajax请求获取数据 -->
                                            ...
                                            <div class="layui-btn-group">
	                                        	<button type="button" onclick="xadmin.open('编辑','ticket-edit.jsp?id=`+item.id+`')" class="layui-btn ">修改</button>
	                                            <button type="button" onclick="window.location.href = 'Tickets?action=delete&id=`+item.id+`'"  class="layui-btn">删除</button>
	                                         </div>
	                                	</td>
									</tr>
								`)	
