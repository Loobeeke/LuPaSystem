...
<body style="background-image: url(images/login_bg~1.jpg); width: 100% ;height: 100%;">
<section class="aui-content">
	<div style="height:20px;"></div>
	<div class="aui-content-up">
		<form action="Info?action=add" name="form1" method="post" role="form" enctype="multipart/form-data">
			<div class="aui-content-up-form">
				<h1>发布资讯</h1>
			</div>
			<div class="aui-form-group clear">
				<label class="aui-label-control"for="theading">
					标题 <em>*</em>
				</label>
				<div class="aui-form-input">
					<input type="text" class="aui-form-control-two" name="theading" onBlur="checkna()" required id="1" placeholder="请输入资讯标题">
			...
			<div class="aui-form-group clear">
				...
				<div class="aui-form-input">
					<textarea class="aui-form-control" name="tcontent" id="2" minlength="1" required onBlur="checkna1()"placeholder="请输入资讯内容..."></textarea>
			...
			<div class="aui-form-group clear">
					...
					<div class="aui-content-img-box aui-content-full">
						<div class="aui-photo aui-up-img clear">
							<section class="aui-file-up fl">
								...
								<!-- <input type="file" name="tpicture" id="file" class="file"   value="images/login_bg.jpg" /> -->
				...
				<div class="aui-form-input">
					...
					<input type="hidden"name="tdate"id="date">
				</div>
				<div class="aui-form-input">
					<label class="aui-label-control" for="ttime"></label>
