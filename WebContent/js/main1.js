	...
	$('.quick-view-trigger').on('click', function(e){
		...
		$.ajax({
			...
			success:function(result){
				...
				$("#P1").attr("href",result.picture);
				$("#P2").attr("href",result.picture);
				$("#P3").attr("href",result.picture);
				$("#P4").attr("href",result.picture);
				$("#i1").attr("src",result.picture);
				$("#i2").attr("src",result.picture);
				$("#i3").attr("src",result.picture);
				$("#i4").attr("src",result.picture);
				$("#i5").attr("src",result.picture);
				$("#i6").attr("src",result.picture);
				$("#i7").attr("src",result.picture);
				$("#i8").attr("src",result.picture);
				$("#P5").attr("src",result.picture);
				$("#N1").html(result.name);
				$("#D1").html(result.detail);
				$("#PI1").html(result.price);
				$("#PI2").html(result.oldprice);
				$("#S1").html(result.stock);
